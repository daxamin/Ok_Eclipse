...
import org.eclipse.jdt.internal.ui.text.correction.NullAnnotationsCorrectionProcessor;
	  ...
	  private void process(
	    ...
	    switch (id) {
	      ...
	      case IProblem.InvalidUnionTypeReferenceSequence:
	        ...
	        break;
	      case IProblem.RedundantSuperinterface:
	        LocalCorrectionsSubProcessor.addRedundantSuperInterfaceProposal(
	            context, problem, proposals);
	        break;
	      case IProblem.VoidMethodReturnsValue:
	      ...
	      case IProblem.InstanceFieldDuringConstructorInvocation:
	        ModifierCorrectionSubProcessor.addNonAccessibleReferenceProposal(
	            ...
	            problem,
	            proposals,
	            ModifierCorrectionSubProcessor.TO_STATIC,
	      ...
	      case IProblem.IllegalModifierForInterfaceMethod18:
	        ModifierCorrectionSubProcessor.addRemoveInvalidModifiersProposal(
	            context, problem, proposals, IProposalRelevance.REMOVE_INVALID_MODIFIERS);
	        break;
	      case IProblem.NotVisibleField:
	        GetterSetterCorrectionSubProcessor.addGetterSetterProposal(
	            context, problem, proposals, IProposalRelevance.GETTER_SETTER_NOT_VISIBLE_FIELD);
	        ModifierCorrectionSubProcessor.addNonAccessibleReferenceProposal(
	            context,
	            problem,
	            proposals,
	      ...
	      case IProblem.NeedToEmulateConstructorAccess:
	        ModifierCorrectionSubProcessor.addNonAccessibleReferenceProposal(
	            ...
	            problem,
	            proposals,
	            ModifierCorrectionSubProcessor.TO_NON_PRIVATE,
	      ...
	      case IProblem.UnqualifiedFieldAccess:
	        GetterSetterCorrectionSubProcessor.addGetterSetterProposal(
	            context, problem, proposals, IProposalRelevance.GETTER_SETTER_UNQUALIFIED_FIELD_ACCESS);
	      ...
	      case IProblem.InvalidUsageOfAnnotationDeclarations:
	        ReorgCorrectionsSubProcessor.getNeedHigherComplianceProposals(
	            context, problem, proposals, JavaCore.VERSION_1_5);
	        break;
	      case IProblem.DiamondNotBelow17:
	      ...
	      case IProblem.SwitchOnStringsNotBelow17:
	        ReorgCorrectionsSubProcessor.getNeedHigherComplianceProposals(
	            context, problem, proposals, JavaCore.VERSION_1_7);
	        break;
	      case IProblem.ExplicitThisParameterNotBelow18:
	      case IProblem.DefaultMethodNotBelow18:
	      case IProblem.StaticInterfaceMethodNotBelow18:
	      ...
	      case IProblem.InvalidUsageOfTypeAnnotations:
	        ReorgCorrectionsSubProcessor.getNeedHigherComplianceProposals(
	            context, problem, proposals, JavaCore.VERSION_1_8);
	        break;
	      case IProblem.NonGenericType:
	      ...
	      case IProblem.MethodMustOverride:
	      case IProblem.MethodMustOverrideOrImplement:
	        ModifierCorrectionSubProcessor.removeOverrideAnnotationProposal(
	            context, problem, proposals);
	        break;
	      case IProblem.FieldMissingDeprecatedAnnotation:
	      case IProblem.MethodMissingDeprecatedAnnotation:
	      case IProblem.TypeMissingDeprecatedAnnotation:
	        ...
	        break;
	      case IProblem.OverridingDeprecatedMethod:
	        ModifierCorrectionSubProcessor.addOverridingDeprecatedMethodProposal(
	            context, problem, proposals);
	        break;
	      case IProblem.IsClassPathCorrect:
	      ...
	      case IProblem.UnsafeElementTypeConversion:
	        ...
	        break;
	      case IProblem.RedundantSpecificationOfTypeArguments:
	        LocalCorrectionsSubProcessor.addRemoveRedundantTypeArgumentsProposals(
	            context, problem, proposals);
	        break;
	      case IProblem.FallthroughCase:
	      ...
	      case IProblem.MissingEnumConstantCase:
	      case IProblem.MissingEnumDefaultCase:
	        LocalCorrectionsSubProcessor.getMissingEnumConstantCaseProposals(
	            context, problem, proposals);
	        break;
	      case IProblem.MissingDefaultCase:
	      ...
	      case IProblem.MissingSynchronizedModifierInInheritedMethod:
	        ...
	        break;
	      case IProblem.UnusedObjectAllocation:
	        LocalCorrectionsSubProcessor.getUnusedObjectAllocationProposals(
	            context, problem, proposals);
	        break;
	      case IProblem.MethodCanBeStatic:
	      case IProblem.MethodCanBePotentiallyStatic:
	      ...
	      case IProblem.PotentialHeapPollutionFromVararg:
	        ...
	        break;
	      case IProblem.UnsafeGenericArrayForVarargs:
	        VarargsWarningsSubProcessor.addAddSafeVarargsToDeclarationProposals(
	            context, problem, proposals);
	        break;
	      case IProblem.SafeVarargsOnFixedArityMethod:
	      case IProblem.SafeVarargsOnNonFinalInstanceMethod:
	      ...
	      case IProblem.IllegalRedefinitionToNonNullParameter:
	        ...
	        NullAnnotationsCorrectionProcessor.addNullAnnotationInSignatureProposal(
	            context, problem, proposals, ChangeKind.LOCAL, isArgProblem);
	        NullAnnotationsCorrectionProcessor.addNullAnnotationInSignatureProposal(
	            context, problem, proposals, ChangeKind.OVERRIDDEN, isArgProblem);
	        break;
	      case IProblem.RequiredNonNullButProvidedSpecdNullable:
	      case IProblem.RequiredNonNullButProvidedUnknown:
	      ...
	      case IProblem.ParameterLackingNonNullAnnotation:
	      case IProblem.ParameterLackingNullableAnnotation:
	        NullAnnotationsCorrectionProcessor.addReturnAndArgumentTypeProposal(
	            context, problem, ChangeKind.LOCAL, proposals);
	        NullAnnotationsCorrectionProcessor.addReturnAndArgumentTypeProposal(
	            context, problem, ChangeKind.TARGET, proposals);
	        break;
	      case IProblem.SpecdNonNullLocalVariableComparisonYieldsFalse:
	      case IProblem.RedundantNullCheckOnSpecdNonNullLocalVariable:
	        ...
	        if (prj != null
	            && JavaCore.ENABLED.equals(
	                prj.getOption(JavaCore.COMPILER_ANNOTATION_NULL_ANALYSIS, true))) {
	          NullAnnotationsCorrectionProcessor.addReturnAndArgumentTypeProposal(
	              context, problem, ChangeKind.LOCAL, proposals);
	        }
	        break;
	      ...
	      case IProblem.RedundantNullDefaultAnnotationMethod:
	        NullAnnotationsCorrectionProcessor.addRemoveRedundantAnnotationProposal(
	            context, problem, proposals);
	        break;
	      case IProblem.UnusedTypeParameter:
	      ...
	      case IProblem.ConflictingInheritedNullAnnotations:
	        NullAnnotationsCorrectionProcessor.addReturnAndArgumentTypeProposal(
	            context, problem, ChangeKind.LOCAL, proposals);
	        NullAnnotationsCorrectionProcessor.addReturnAndArgumentTypeProposal(
	            context, problem, ChangeKind.INVERSE, proposals);
	        break;
	      default:
	    }
